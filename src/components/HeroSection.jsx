        ...
        <>
            ...
            >
                <div className="grid grid-cols-1 sm:grid-cols-12 place-items-center">
                    ...
                    >
                        <h1 className="text-white mb-4 text-4xl sm:text-4xl md:text-5xl lg:text-5xl font-[700] lg:leading-normal">
                        Hey there 😊 <br /> I&apos;m{" "}
                            <span className="text-heading">Amol Mali</span> a{" "}
                        ...
                        <TypeAnimation
                            ...
                            sequence={[
                                500, "I'm a PHP Developer.",
                                1000, "I'm a MERN Stack Developer.",
                                1000, "I build interactive UI using React.",
                                1000, "I convert designs into Modern UI.",
                                1000, "I make ideas & things alive.",
                                500,
                            ]}
                            speed={50}
                            // style={{ fontSize: "10px" }}
